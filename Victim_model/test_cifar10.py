...
parser.add_argument('--ratio', type=int, default=1,
                    help='train with trigger every "ratio" batch')
...
parser.add_argument('--task', default="BASE", type=str,
                    help='train strategy , w/o transform ')
...
def main():
    ...
    transform_test_list = [transform_test1, transform_test2,
                           transform_test3, transform_test4, transform_test5]
    data_aug_list = [data_aug1, data_aug2, data_aug3, data_aug4, data_aug5]
    ...
    test_clean = "/home/ljh/dataset/cifar10_poisonink/val"
    test_wm = args.wm_tst
    target = args.target
    ...
    for i in range(test_num):
        ...
        wm_test_dataset = data.my_wm_dataset.wm_folder(
            root=test_wm, transform=transform_test, target=target)
        ...
        wm_testloader = DataLoader(
            wm_test_dataset, batch_size=args.test_batch, shuffle=False, num_workers=args.workers)
        ...
        test_loss_wm2, test_acc_wm2 = test(
            wm_testloader, model, criterion,  use_cuda)
