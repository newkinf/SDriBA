...
def make_infect_val(coverdir, datasetdir, Hnet_path, secret_img_path):
    ...
    for target in sorted(os.listdir(coverdir)):
        ...
        with torch.no_grad():
            loader = transforms.Compose([transforms.ToTensor()])
            # loader_secret = torchvision.transforms.Compose([torchvision.transforms.Resize(128),torchvision.transforms.ToTensor()])
            loader_secret = torchvision.transforms.Compose([torchvision.transforms.ToTensor()])
            secret_img = Image.open(secret_img_path).convert("RGB")
            secret_img = loader_secret(secret_img)
            secret_img = secret_img.cuda()
            secret_img = secret_img.unsqueeze(0)
...
if __name__ == '__main__':
    ...
    coverdir = "/home/ljh/dataset/ImageNet_clean_128/train"
    # val_coverdir = "/home/ljh/dataset/ImageNet_clean_128/val"
    val_coverdir = "/home/ljh/dataset/ImageNet_clean_128/test"

    target_class = 'Americanegret'
    portion = 0.1
    datasetdir = "/home/ljh/dataset/infect_imagenet/one_poison_label/hinet_single_img/single_warplane2/rev_cover_24-2-29_checkpoint115/Americanegret/10per"
    Hnet_path = '/home/ljh/HiNet/model/imagenet/size_128/single_warplane2/rev_cover/rev5_24-2-29/model_checkpoint_00115.pt'
    secret_img_path = "/home/ljh/dataset/imagenet_hinet/single_warplane2_128/n04552348_2681_2.png"
    val_datasetdir = "/home/ljh/dataset/infect_imagenet/one_poison_label/hinet_single_img/single_warplane2/rev_cover_24-2-29_checkpoint115/Americanegret/bdtest"
